 ...
 */
FCOjima.Carpool.Assignment.createCarLayout = function(car, carIndex, existingAssignments) {
    // 車両レイアウトのコンテナ
 ...
 */
FCOjima.Carpool.Assignment.createDriverSeat = function(driverName, carIndex) {
 ...
 */
FCOjima.Carpool.Assignment.createSeat = function(seatType, seatIndex, carIndex) {
 ...
 */
FCOjima.Carpool.Assignment.setSeatOccupant = function(seat, personName) {
 ...
 */
FCOjima.Carpool.Assignment.getNameInitials = function(name) {
    if (!name) return '';
 ...
 * @returns {string} ラベル
 */
FCOjima.Carpool.Assignment.getProvideTypeLabel = function(type) {
    const types = {
        'both': '行き帰り可能',
        'no': '不可',
        'to': '行きのみ可能',
 ...
 */
FCOjima.Carpool.Assignment.createMemberItem = function(member) {
        ...
        seat.addEventListener('drop', function(e) {
            ...
            try {
                ...
                if (jsonData.type === 'seat') {
                    FCOjima.Carpool.Assignment.handleSeatExchange(
                    ...
                    // 新規配置
                    FCOjima.Carpool.Assignment.setSeatOccupant(this, memberName);
        ...
        membersContainer.addEventListener('drop', function(e) {
            ...
            try {
                ...
                if (jsonData.type === 'seat') {
                    ...
                    if (seat) {
                        FCOjima.Carpool.Assignment.clearSeat(seat);
 ...
 */
FCOjima.Carpool.Assignment.handleSeatExchange = function(fromCarIndex, fromSeatType, fromSeatIndex, toCarIndex, toSeatType, toSeatIndex) {
 ...
 * @param {HTMLElement} seat - 座席要素
 */
FCOjima.Carpool.Assignment.clearSeat = function(seat) {
